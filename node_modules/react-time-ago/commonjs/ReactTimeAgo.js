...
var _getVerboseDateFormatter = require('./helpers/getVerboseDateFormatter');

var _getVerboseDateFormatter2 = _interopRequireDefault(_getVerboseDateFormatter);

var _date = require('./helpers/date');

var _getTimeAgo = require('./helpers/getTimeAgo');
...
function ReactTimeAgo(_ref) {
	...
	var timeAgo = (0, _react.useMemo)(function () {
		return (0, _getTimeAgo2.default)(preferredLocales, { polyfill: polyfill });
	...
	var verboseDateFormatter = (0, _react.useMemo)(function () {
		return (0, _getVerboseDateFormatter2.default)(preferredLocales, verboseDateFormat);
...
ReactTimeAgo.propTypes = {
	...
	wrapperComponent: _propTypes2.default.elementType,
